...
# copy receptor + ligand.pdb  here and copy to myprotein.pdb
...
#cp src-DAS-acpype-10w.pdb  myprotein.pdb
...
### get ligand top for first ligand
...
#cp param/${LIGNAME}/${LIGNAME}.acpype/${LIGNAME}_NEW.pdb .
